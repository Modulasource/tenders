...
<%
	String sTitle = "Ajouter un contenu rédactionnel";
	...
	if(iIdTypeObjet == ObjectType.ORGANISATION)
	{
		...
		{
			sPageUseCaseId = "IHM-DESK-AR-002";
		}
	...
	if(iIdTypeObjet == ObjectType.PERSONNE_PHYSIQUE)
	{
		...
		{
			sPageUseCaseId = "IHM-DESK-AR-003";
		}
	...
	EditorialAssistance edit = new EditorialAssistance();
%>
<%@ include file="../include/checkHabilitationPage.jspf" %>
<script type="text/javascript" src="<%= rootPath %>include/verification.js"></script>
<script type="text/javascript">
<%@ include file="pave/ajouterEditorialAssistance.jspf" %>
</script>
</head>
<body>
...
%>
<form action="<%=response.encodeURL("modifierEditorialAssistance.jsp?sAction="+sAction)%>" method="post" name="formulaire" onSubmit="return checkForm();">
<%@ include file="pave/paveAjouterEditorialAssistanceForm.jspf" %>
<br />
<div style="text-align:center">
	...
	<input type="button" name="RAZ" value="Annuler" onclick="Redirect('<%= response.encodeURL("afficherTousEditorialAssistance.jsp") %>')" />
</div>
</form>
