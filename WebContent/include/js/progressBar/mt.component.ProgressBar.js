  ...
  */
 	...
 	// Default Options
		var defaultOptions = {
			...
			boxImage	: rootPath+'/include/js/progressBar/images/bramus/percentImage.png',			// boxImage : image around the progress bar
			barImage	: rootPath+'/include/js/progressBar/images/bramus/percentImage_back1.png',	// Image to use in the progressbar. Can be an array of images too.
