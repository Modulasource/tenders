...
Autocomplete.prototype = {
  ...
  suggest: function() {
    ...
    //var re = new RegExp("("+this.currentValue.replace(/("|'|\\|\(|\)|\.|\?|\*)/gi, "\\$1")+")", 'gi');
    var sMatch = this.prepareForAccents(this.currentValue.replace(/("|'|\\|\(|\)|\.|\?|\*)/gi, "\\$1"));
  ...
  //replace all accent by a group of characters in order to hilight char with no accent distinction 
  prepareForAccents: function(s){	
      var r=s.toLowerCase();
      r = r.replace(new RegExp(/æ/g),"ae");
      r = r.replace(new RegExp(/œ/g),"oe");
      r = r.replace(new RegExp(/[aàáâãäå]/g),"[aàáâãäå]");
      r = r.replace(new RegExp(/[cç]/g),"[cç]");
      r = r.replace(new RegExp(/[eèéêë]/g),"[eèéêë]");
      r = r.replace(new RegExp(/[ìíîïi]/g),"[ìíîïi]");
      r = r.replace(new RegExp(/[ñn]/g),"[ñn]");                
      r = r.replace(new RegExp(/[òóôõöo]/g),"[òóôõöo]");      
      r = r.replace(new RegExp(/[ùúûüu]/g),"[ùúûüu]");
      r = r.replace(new RegExp(/[ýÿy]/g),"[ýÿy]");
      return r;
  },
