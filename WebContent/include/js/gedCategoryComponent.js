...
function gedCategoryComponent(placeHolder, dataSet) {
	var self = this;
	this.selections = [];
	
	this.emptyMsg = '<div style="text-align:center;color:#BBB;font-size:20px;margin-top:70px">Sélectionnez un ou plusieurs éléments</div>';
	...
	function loadChilds(itemJC) {
		GedCategory.getJSONArrayFromParent(itemJC.lId, function(sJSON){
...
function gedCategoryComponentExplorer(placeHolder, dataSet, engine) {
	var self = this;
	this.selections = [];
	this.value = 0;
	this.iIndex = 0;
	...
	this.emptyMsg = '<div style="text-align:center;color:#BBB;font-size:20px;margin-top:70px">Sélectionnez une ou plusieurs catégories</div>';
	...
	this.build = function() {
		...
		a0.innerHTML = "Toutes les catégories";
