...
<table cellspacing="3" cellpadding="3">
  <tr>
    ...
    <td style="width:70%"><p>CONSULTEZ GRATUITEMENT <a href="<%=response.encodeURL("public/annonce/afficherAnnonces.jsp")%>">LES LEGALES</a>
             couverte la Communauté de communes Artois-Lys !
        <p> En vous connectant sur cette plateforme sécurisée, consultez tous les marchés dématérialisés et
                 téléchargez sans attendre les dossiers de consultation ! </p>
        <p> Attention, pour soumissionner au format électronique vous devez vous munir d'un 
            ...
            électronique</a> émanant d'une autorité de certification agréée par le MINEFE et vous laisser guider
             par nos conseils d'utilisation. 
        </p>
	</td>
  </tr>
</table>
