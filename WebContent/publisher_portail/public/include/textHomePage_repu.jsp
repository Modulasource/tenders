...
<table cellspacing="3" cellpadding="3">
  <tr>
    ...
    <td style="width:70%"><p>CONSULTEZ GRATUITEMENT <a href="<%=response.encodeURL("public/annonce/afficherAnnonces.jsp")%>">LES LEGALES</a> DE VOTRE REGION
             couverte par  Le Républicain Lorrain, l'Alsace - Le Pays !
        ...
        <p> Attention, pour soumissionner au format électronique vous devez vous munir d'un 
            <a href="<%=response.encodeURL("public/pagesStatics/certificat/commanderCertificat.jsp")%>">certificat 
                électronique</a> émanant d'une autorité de certification agréée par le MINEFE et vous laisser 
            guider par nos conseils d'utilisation. 
        </p>
	</td>
  </tr>
</table>
