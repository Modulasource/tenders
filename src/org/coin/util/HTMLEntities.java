...
public class HTMLEntities {
	...
	public static String htmlentities(String str) {
		...
		for (int i = 0; i < str.length(); ++i) {
			...
			String entity = htmlentities_map.get(new Integer(ch)); //get equivalent html entity
	...
	public static String unhtmlentities(String str) {
		...
		return  unhtmlentities(str, null);
	}
	 ...
	 */
	public static String unhtmlentities(String str, String sDiscardEntity) {
		...
		for (int i = 0; i < str.length(); ++i) {
			...
			if (ch == '&') {
				...
				if(sDiscardEntity != null) 
				{
					if(entity.equals(sDiscardEntity))
						continue;
				}
	...
	/*
	public static String htmlSingleQuotesUsingMail(String str) {
		str = str.replaceAll("[\']", "&rsquo;");
		str = str.replaceAll("&#039;", "&rsquo;");
		str = str.replaceAll("&#145;", "&rsquo;");
		str = str.replaceAll("&#146;", "&rsquo;");
	...
	*/
	...
	public static String htmlentitiesComplete(String str) {
		str = htmlentities(str);
		str = htmlQuotes(str);
		str = htmlAngleBrackets(str);
		return str;
	}
	
	public static String htmlentitiesWithTag(String str) {
		str = htmlentities(str);
		str = htmlQuotes(str);
		return str;
	}
	
	public static String unhtmlentitiesComplete(String str) {
		str = unhtmlentities(str);
		str = unhtmlQuotes(str);
		str = unhtmlAngleBrackets(str);
		return str;
	}
	
	public static String unhtmlentitiesXmlComplete(String str) {
		str = unhtmlentities(str, "&amp;");
		str = unhtmlQuotes(str);
		str = unhtmlAngleBrackets(str);
		//str = unhtmlAmpersand(str);
		return str;
	}
